...
export default {
  ...
  created() {
  let apiUrl = `https://bl0gg3r.herokuapp.com/topics/${this.$route.params.id}`
    axios.get(apiUrl)
  ...
  methods: {
    addToApi () {
      let apiURL = `https://bl0gg3r.herokuapp.com/topics/update/${this.$route.params.id}`
     axios.post(apiURL, this.Topic)
     .then((response) => {
